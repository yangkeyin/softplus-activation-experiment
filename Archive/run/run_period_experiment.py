...
PERIOD_LIST = np.array([1.5, 1.75, 1.9, 2.0, 2.1, 2.25, 2.5]) * FIXED_WIDTH
...
# --- 输出配置 ---
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "../results/period/1014_SmallPoint_ShortPeriod_8trainPoints")
